...
def val(args, val_loader, model, epoch):
    ...
    for iter, batched_inputs in enumerate(val_loader):
        ...
        # run the mdoel
        out, out2, out3, out4 = model(pre_img_var, post_img_var)
        loss = BCEDiceLoss(out, target_var) + BCEDiceLoss(out2, target_var) + BCEDiceLoss(out3, target_var) + \
               BCEDiceLoss(out4, target_var)
...
def trainValidateSegmentation(args):
    ...
    if args.file_root == 'LEVIR':
        args.file_root = '/media/pan/3222DC3BFC0A65B0/LEVIR_crop'
    elif args.file_root == 'BCDD':
        args.file_root = '/media/pan/3222DC3BFC0A65B0/CD/CD_Dataset/WUH-BCDD'
    elif args.file_root == 'SYSU':
        args.file_root = '/media/pan/3222DC3BFC0A65B0/CD/CD_Dataset/SYSU-CD'
    elif args.file_root == 'CLCD':
        args.file_root = '/media/pan/3222DC3BFC0A65B0/CD/CD_Dataset/CLCD-256'
    elif args.file_root == 'UAVCD3':
        args.file_root = '/media/pan/3222DC3BFC0A65B0/CD/CD_Dataset/UAV-CD3.0_256'
    else:
    ...
    valLoader = torch.utils.data.DataLoader(
        ...
        batch_size=1, num_workers=args.num_workers, pin_memory=False,drop_last=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_steps', type=int, default=40000, help='Max. n umber of iterations')
    parser.add_argument('--num_workers', type=int, default=8, help='No. of parallel threads')
    parser.add_argument('--batch_size', type=int, default=8, help='Batch si1e')
